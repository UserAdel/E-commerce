...
const MyOrderPage = () => {
  ...
  <div className="relative shadow-md sm:rounded-lg overflow-hidden">
    ...
    {orders.length > 0 ? (
      orders.map((order) => (
        <tr key={order._id} className="border-b hover:border-r-gray-50">
          ...
          <td className={`py-2 px-2 sm:py-4 sm:px-4`}>
            <span className={order.isPaid ? "bg-green-100 text-green-700 rounded-lg px-2 py-1" : "text-red-700 rounded-lg px-2 py-1 bg-red-100"}>
