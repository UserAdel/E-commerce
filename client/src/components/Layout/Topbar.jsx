...
import { IoLogoInstagram } from "react-icons/io5"; // Import Instagram icon
import { RiTwitterXLine } from "react-icons/ri"; // Import Twitter X icon
...
const Topbar = () => {
  return (
    <div className="h-10 text-center bg-[#ea2e0e] text-white flex items-center justify-between px-24 py-6  w-full  ">
      ...
      <div className=" hover:text-gray-300  hover:underline hidden md:block">  <a href="tel:01119915593">
      +(20)1119915593 </a></div>    
    </div>
  );
};
